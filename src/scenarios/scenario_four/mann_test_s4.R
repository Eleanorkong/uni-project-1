## scenario four (mann_test) : explore the effect of effect size 
...
par(mfrow=c(1,3))
set.seed(10)
effect_size_increase(upper = 20, n = 10, test = "wilcox.test")
effect_size_increase(upper = 20, n = 100, test = "wilcox.test")
effect_size_increase(upper = 20, n = 1000, test = "wilcox.test")
...
## plot of power as n increases when effect size is 0.2 / 0.5 / 0.8 
par(mfrow=c(1,3))
set.seed(10)
